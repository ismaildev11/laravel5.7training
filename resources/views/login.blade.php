...
background: linear-gradient(150deg, rgba(246,248,252,1) 0%, rgba(240,37,153,1) 7%, rgba(200,37,19,1) 52%, rgba(223,52,67,1) 84%, rgba(172,97,153,1) 94%, rgba(228,55,131,1) 100%, rgba(61,195,244,1) 100%);  " >
...
<a href="{{url('/redirect')}}" class="btn btn-primary">Login with Facebook</a>            <script>
